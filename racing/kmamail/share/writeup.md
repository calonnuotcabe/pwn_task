...
- Chương trình chạy với quyền gì, attacker kiểm soát được những input nào.
...
### Chương trình chạy với quyền gì và attacker kiểm soát được những input nào?

### Luồng xử lý của chương trình

### Điểm race nằm ở đâu trong quá trình đó, và tài nguyên nào bị đổi trong race window.
